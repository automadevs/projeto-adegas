...
function createProducts(): Product[] {
  return [
    product("MENU-JANTINHA", "Jantinha completa", "Jantinha", "prato", 1999, 18),
    product("ESP-BOI", "Espeto tradicional de boi", "Espetos", "un", 1000, 24),
    product("ESP-MED-FRANGO", "Espeto medalhao de frango", "Espetos", "un", 1200, 16),
    product("ESP-QUEIJO", "Espeto queijo coalho", "Espetos", "un", 900, 16),
    product("POR-CARNE-SOL-FRITAS-M", "Carne de sol com fritas meia", "Porcoes de carne", "porcao", 5000, 10),
    product("POR-FRITAS-BACON-M", "Fritas com queijo e bacon meia", "Porcoes", "porcao", 4000, 10),
    product("PEIXE-TILAPIA-FRITAS-I", "Tilapia com fritas inteira", "Peixes", "porcao", 6000, 6),
    product("CHAPA-CHAPAO", "Chapao completo", "Chapas", "porcao", 11500, 6),
    ...
    product("REFRI-COCA-LATA", "Coca-Cola lata", "Refrigerantes", "un", 600, 20),
    product("REFRI-GUARANA-2L", "Guarana 2 litros", "Refrigerantes", "un", 1200, 14),
    product("SUCO-ABACAXI-COPO", "Suco abacaxi copo", "Suco natural", "copo", 800, 12),
    product("SUCO-ACR-LEITE", "Acrescimo de leite", "Suco natural", "extra", 200, 0),
    product("DOSE-SMIRNOFF", "Dose Vodka Smirnoff", "Doses", "dose", 1200, 20, { ageRestricted: true }),
    product("DOSE-RED-LABEL", "Dose Whisky Red Label", "Doses", "dose", 1500, 18, { ageRestricted: true }),
    product("DOSE-GIN-TANQUERAY", "Dose Gin Tanqueray", "Doses", "dose", 2000, 14, { ageRestricted: true }),
    product("COMBO-SMIRNOFF", "Combo Vodka Smirnoff com 4 Red Bull", "Combos", "combo", 10000, 8, { ageRestricted: true }),
    product("COMBO-RED-LABEL", "Combo Whisky Red Label com 4 Red Bull", "Combos", "combo", 20000, 6, { ageRestricted: true }),
    product("COMBO-GIN-TANQUERAY", "Combo Gin Tanqueray com 4 suco de uva", "Combos", "combo", 20000, 6, { ageRestricted: true }),
