...
function createProducts(): Product[] {
  return [
    product("MENU-JANTINHA", "Jantinha completa", "Refeicoes", "prato", 1999, 18),
    product("ESP-BOI", "Espeto tradicional de boi", "Refeicoes", "un", 1000, 24),
    product("ESP-MED-FRANGO", "Espeto medalhao de frango", "Refeicoes", "un", 1200, 16),
    product("ESP-QUEIJO", "Espeto queijo coalho", "Refeicoes", "un", 900, 16),
    product("POR-CARNE-SOL-FRITAS-M", "Carne de sol com fritas meia", "Refeicoes", "porcao", 5000, 10),
    product("POR-FRITAS-BACON-M", "Fritas com queijo e bacon meia", "Refeicoes", "porcao", 4000, 10),
    product("PEIXE-TILAPIA-FRITAS-I", "Tilapia com fritas inteira", "Refeicoes", "porcao", 6000, 6),
    product("CHAPA-CHAPAO", "Chapao completo", "Refeicoes", "porcao", 11500, 6),
